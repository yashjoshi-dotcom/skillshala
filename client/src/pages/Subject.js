...
const subject = () => {
    ...
    return (
        <>
            <div className="">
                <div className=" bg-gradient-to-b from-gray-700 via-gray-900 to-black   bg-cover font-bold text-5xl italic py-[7%] flex justify-center align-middle text-gray-300"> Computer Science Topics </div>
                <div className=" bg-black min-h-[53vh] ">
                    <div className=" text-white pl-5 pb-5 text-2xl font-semibold ">Data Structures and Algorithms</div>
                    <div className="flex h-fit overflow-x-auto">
                        ...
                        <div class="py-5 px-3 ">
                            <div class="shadow-lg group container  rounded-md bg-white  max-w-sm flex justify-center items-center  mx-auto content-div">
                                <div>
                                    <div class=" h-[10vh] w-[28vw]  image-cover rounded-t-md " >
